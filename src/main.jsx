...
const copy = {
  en: {
    ...
    heroDescription: 'A custom Among Us region, hosted for friends, modded communities, and anyone who wants a quieter corner of the Skeld.',
    heroPrimary: 'Start installation',
    heroSecondary: 'Join Discord',
    heroFootnote: 'Hosted by NikoCat233 · since 2024',
    heroOrigin: 'custom region / impostor',
    regions: 'regions',
    platforms: 'platforms',
    online: 'online now',
    live: 'LIVE SIGNAL',
    checking: 'CHECKING SIGNAL',
    installEyebrow: '01 / CONNECT YOUR GAME',
    installTitle: 'Choose your route in.',
    ...
    rulesLead: 'This is a community server. Keep it competitive, kind, and easy to moderate.',
    rule1: 'No cheating of any kind.',
    rule2: 'No insults, harassment, or racial discrimination.',
    rule3: 'No ban evasion.',
    rule4: 'Breaking these rules may result in a ban.',
    ...
    email: 'Email',
    qq: 'China QQ group',
    footer: 'A small server for big lobbies.',
  ...
  zh: {
    ...
    heroDescription: '一个为朋友、模组社区和想在 Skeld 找到安静角落的玩家准备的 Among Us 自定义区域。',
    heroPrimary: '开始安装',
    heroSecondary: '加入 Discord',
    heroFootnote: 'NikoCat233 维护 · 自 2024 年起',
    heroOrigin: '自定义区域 / impostor',
    regions: '区域',
    platforms: '平台',
    online: '当前在线',
    live: '信号在线',
    checking: '正在检测',
    installEyebrow: '01 / 连接你的游戏',
    installTitle: '选择进入方式。',
    ...
    mobile: 'Android / iPhone',
    mobileShort: '手机',
    mobileDescription: '保持 Among Us 后台运行后点击区域',
    console: '主机平台',
    consoleShort: '主机',
    consoleDescription: 'PS · Xbox · Switch',
    recommended: '推荐方式',
    ...
    rule4: '违反规则可能会被封禁。',
    privacy: '查看隐私政策',
    supportEyebrow: '让服务器继续亮着',
    supportTitle: '由玩家搭建，也由社区一起维持。',
    supportLead: '如果这个服务器帮你找到游戏，可以捐赠支持托管和域名费用。',
    kofi: '通过 Ko-fi 赞助',
    wechat: '微信赞助',
    contact: '联系方式',
